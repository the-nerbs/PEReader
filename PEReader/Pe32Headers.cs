...
{
    /// <summary>
    /// Accessor for 32-bit PE (PE32) files.
    /// </summary>
    internal sealed class Pe32Headers : IPeHeadersInternal
    {
        private readonly IMAGE_NT_HEADERS32 _ntHeader;
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="Pe32Headers"/>.
        /// </summary>
        /// <param name="peStream">
        /// The stream to the PE file, positioned at the <see cref="IMAGE_NT_HEADERS32"/> structure.
        /// </param>
        public Pe32Headers(Stream peStream)
        {
            _ntHeader = peStream.Read<IMAGE_NT_HEADERS32>();

            // read the data directories
            int nDirectories = unchecked((int)_ntHeader.OptionalHeader.NumberOfRvaAndSizes);
